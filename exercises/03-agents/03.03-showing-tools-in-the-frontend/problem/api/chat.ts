...
import {
  ...
  stepCountIs,
  streamText,
  tool, type InferUITools, type UIMessage
} from 'ai';
import { z } from 'zod';
...
// ? Typesafety is ensured by the InferUITools<typeof tools> type argument - very interesting pattern to integrate with the UI components
